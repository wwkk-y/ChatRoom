...
![](http://www.kdocs./attach/object/HHOHXFA2ACQBI? "po_bhcdgbjeiicjga")
### 多节点通信
...
| 某一条消息已读 | /service/im/message/read                       | {<br>    "id": 123,<br>    "room_code": "123456789"<br>}                                                                                                                                                                                                                                                                       | - 返回的是 im_message 表里的一行数据, 字段含义参考"数据库"<br><br>> 避免使用数据库                                                        |
